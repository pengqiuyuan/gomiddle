...
func StatusStart(builder *flatbuffers.Builder) { builder.StartObject(5) }
...
func StatusAddStatus(builder *flatbuffers.Builder, status int32) { builder.PrependInt32Slot(4, status, 0) }
